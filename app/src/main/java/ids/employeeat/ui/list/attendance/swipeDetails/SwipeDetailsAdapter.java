package ids.employeeat.ui.list.attendance.swipeDetails;
...
public class SwipeDetailsAdapter extends RecyclerView.Adapter<SwipeDetailsAdapter.MyViewHolder> {
    private LayoutInflater inflater;
    private JSONArray dataArray = new JSONArray();

    public SwipeDetailsAdapter(Context context)
    {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position)
    {
        ...
        {
            LogUtil.logException("SwipeDetailsAdapter", e);
        }
    }
